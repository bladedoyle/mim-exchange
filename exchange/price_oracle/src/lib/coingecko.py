...
if __name__ == "__main__":
    cg = CoinGeckoAPI()
    monero = cg.get_coin_by_id("monero")
    print(monero["market_data"]["current_price"]["btc"])
    print(monero["market_data"]["current_price"]["usd"])

    bitcoin = cg.get_coin_by_id("bitcoin")
    print(bitcoin["market_data"]["current_price"]["usd"])

    litecoin = cg.get_coin_by_id("litecoin")
    print(litecoin["market_data"]["current_price"]["btc"])
    print(litecoin["market_data"]["current_price"]["usd"])

    bitcoincash = cg.get_coin_by_id("bitcoin-cash")
    print(bitcoincash["market_data"]["current_price"]["btc"])
    print(bitcoincash["market_data"]["current_price"]["usd"])

    zcash = cg.get_coin_by_id("zcash")
    print(zcash["market_data"]["current_price"]["btc"])
    print(zcash["market_data"]["current_price"]["usd"])
    
    dash = cg.get_coin_by_id("dash")
    print(dash["market_data"]["current_price"]["btc"])
    print(dash["market_data"]["current_price"]["usd"])

    doge = cg.get_coin_by_id("dogecoin")
    print(doge["market_data"]["current_price"]["btc"])
    print(doge["market_data"]["current_price"]["usd"])

    wownero = cg.get_coin_by_id("wownero")
    print(wownero["market_data"]["current_price"]["btc"])
    print(wownero["market_data"]["current_price"]["usd"])