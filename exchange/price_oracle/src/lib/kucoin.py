...
if __name__ == "__main__":
    kc = MarketData()
    print(kc.get_ticker("XMR-BTC"))
    print(kc.get_ticker("XMR-USDT"))
    
    print(kc.get_ticker("BTC-USDT"))
    print(kc.get_ticker("BTC-USDC"))

    print(kc.get_ticker("LTC-BTC"))
    print(kc.get_ticker("LTC-USDT"))
    print(kc.get_ticker("LTC-USDC"))

    print(kc.get_ticker("BCH-BTC"))
    print(kc.get_ticker("BCH-USDT"))
    print(kc.get_ticker("BCH-USDC"))

    print(kc.get_ticker("ZEC-BTC"))
    print(kc.get_ticker("ZEC-USDT"))

    print(kc.get_ticker("DASH-BTC"))
    print(kc.get_ticker("DASH-USDT"))

    print(kc.get_ticker("DOGE-BTC"))
    print(kc.get_ticker("DOGE-USDT"))